...
function Brand({ light = false }: { light?: boolean }) {
  return <span className={`brand-lockup${light ? " light" : ""}`}><Image src="/brand/zecar-mark.png" alt="" width={24} height={38}/><span className="brand">ZE<span>CAR</span></span></span>;
}
